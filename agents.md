...
### 🐳 WSL2 + Docker деплой (НОВЫЙ РЕКОМЕНДУЕМЫЙ СПОСОБ)

С января 2026 года основной способ деплоя - использование WSL2 + Docker на локальной машине.
